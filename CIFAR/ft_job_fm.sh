...
for N in 4 8 16 32 64 128 256 512 1024 2048 4096; do
    python train.py --dataset FashionMNIST --score energy --n_ood $N --regime Balanced --epochs 100
    python test.py --dataset FashionMNIST --score energy --num_to_avg 5 --type ft --ft_n $N --ft_epochs 99 --regime Balanced
done