...
python jobs/generate_jobs.py --regime Balanced --exp CIFAR10-SVHN --dir CIFAR10-SVHN --method energy --time "00:30:00"
...
python jobs/generate_jobs.py --regime Balanced --exp CIFAR10-SVHN --dir CIFAR10-SVHN --method OE  --time "00:30:00"
